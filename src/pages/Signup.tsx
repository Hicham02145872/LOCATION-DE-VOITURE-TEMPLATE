...
import { Car, X, Eye, EyeOff, Mail, Lock, UserPlus } from "lucide-react"
import { supabase } from "@/lib/supabase"

function Signup({ onClose, onSwitch }: { onClose?: () => void; onSwitch?: () => void }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!supabase) {
      setLoading(false)
      setError(t("auth.signup.supabaseError"))
      return
    }
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      placeholder={t("auth.signup.mdpPlaceholder")}
                      value={password}
                ...
                >
                  {loading ? (
                    <span className="flex items-center gap-2">
                      ...
                      {t("auth.signup.inscrireEnCours")}
                    </span>
                  ) : (
                    <span className="flex items-center gap-2">
                      <UserPlus className="h-4 w-4" />
                      {t("auth.signup.inscrire")}
                    </span>
                  )}
                </Button>
              </form>
